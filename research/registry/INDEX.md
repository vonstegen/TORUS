...
`TESTING` (moved from UNTESTED on EXP-A-03x PASS / CP1.2, 2026-08-22).
...
| EXP-AF-001 | A | AF1 equal-training-budget control (T1-continued vs T1+T2, n=3) | DECIDED | FAIL | **A-RP-001 FALSIFIED under matched CE.** T1+T2 vs T1-continued, identical batches / optimizer / objective / seed-001,002,003. Wikitext ppl 34.81 vs 14.10 (+9.09 stderr in favor of A), arc_easy 0.635 vs 0.649 (-2.23 stderr), lambada 0.565 vs 0.618 (-6.24 stderr). A wins on all 3 capability metrics by >2 stderr. A-RP-001 → DECIDED FAIL. Track B stays locked. EXP-AF-002 (equal-storage control) unblocked per verdict recommendations. |

## Decision log updates
- **2026-08-22 — A-RP-001 DECIDED FAIL** (via `EXP-AF-001`, run `research/track-a-residual-ternary/residual-falsification/experiments/AF1/runs/20260822T234553Z`; git_sha `39be76c`).
  - Trigger: T1+T2 loses to T1-continued at matched budget on every capability metric.
  - Effect on other claims: A-RP-002 / A-RP-003 remain UNTESTED; the v2 suite's equal-storage control `EXP-AF-002` is now the next-priority falsifier.
